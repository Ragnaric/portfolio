  ...
  return (
    <div className="w-7/12 m-auto pt-24 mt-24 justify-center">
      ...
      <div className="flex-row text-center space-x-12 pb-12 mb-12">
        <i className="fa-brands fa-linkedin fa-3x text-white hover:text-rose-800" onClick={() => {
          window.open('https://www.linkedin.com/in/jonathan-navarrete');
        }}></i>
        <i className="fa-regular fa-envelope fa-3x text-white hover:text-rose-800" onClick={() => {
          window.open('mailto:jonathan3navarrete@gmail.com');
        }}></i>
        <i className="fa-brands fa-github fa-3x text-white hover:text-rose-800" onClick={() => {
