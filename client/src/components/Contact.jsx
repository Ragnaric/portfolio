...
const Contact = () => {
  ...
  return (
    <div className={`${inView ? 'transition-opacity' : 'opacity-0'} w-7/12 m-auto justify-center duration-[2000ms]`} ref={ref}>
      <div className="text-center text-rose-800 text-5xl md:max-lg:text-3xl p-4 m-2">Contact</div>
      <div className="text-center text-white text-2xl md:max-lg:text-base p-4 m-2">Contact me on LinkedIn or send me an email. You should also check out my GitHub.</div>
