...
const Menu = ({menuOpen, home, about, projects, contact}) => {
  ...
  return (
    <div className={`${!menuOpen ? '-top-1/3 landscape:-top-full' : 'top-0'} w-80 h-1/3 landscape:h-full fixed z-10 bg-rose-800 right-0 flex flex-col justify-center items-center duration-[1250ms] lg:hidden`}>
