...
const ProjectCard = () => {
  ...
  return (
    <div className="whitespace-nowrap transition-transform">
      ...
      <div className={`${MinesVis ? 'transition-opacity' : 'opacity-0'} inline-flex flex-row flex-nowrap w-full justify-center overflow-hidden duration-[2000ms]`} ref={MinesYours}>
        <div className="inline-flex flex-col max-w-7/12 landscape:w-1/3 p-2 m-2 whitespace-wrap break-normal justify-center items-center">
          ...
          <div className="text-white text-2xl landscape:max-lg:text-sm text-justify">A barter marketplace platform to build community, reduce waste, and make it easier to help others. It was created as a final team project for Hack Reactor. I was personally responsible for the back-end, including queries and pagination.</div>
        </div>
        <div className="inline-flex p-2 m-2 landscape:w-3/5 justify-center">
