...
const ProjectCard = () => {
  ...
  return (
    <>
      <div className={`${AtelierVis ? 'transition-opacity' : 'opacity-0'} flex-row flex-wrap m-auto w-11/12 justify-center overflow-hidden space-x-48 duration-[2000ms]`} ref={Atelier}>
      ...
      <div className={`${MinesVis ? 'transition-opacity' : 'opacity-0'} flex-row flex-wrap m-auto w-11/12 justify-center overflow-hidden space-x-48 duration-[2000ms]`} ref={MinesYours}>
        <div className="inline-flex flex-col p-2 m-2 whitespace-wrap break-normal w-1/3 relative bottom-72 ml-24">
