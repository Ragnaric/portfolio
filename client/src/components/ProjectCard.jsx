...
const ProjectCard = () => {
  ...
  return (
    <>
      <div className={`${AtelierVis ? 'transition-opacity' : 'opacity-0'} flex flex-row flex-wrap w-full justify-center overflow-hidden space-x-12 duration-[2000ms] py-12 my-12`} ref={Atelier}>
      ...
      <div className={`${MinesVis ? 'transition-opacity' : 'opacity-0'} flex flex-row flex-wrap w-full justify-center overflow-hidden space-x-12 duration-[2000ms] py-12 my-12`} ref={MinesYours}>
        <div className="inline-flex flex-col p-2 m-2 whitespace-wrap break-normal w-1/3 align-center">
