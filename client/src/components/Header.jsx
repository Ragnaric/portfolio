  ...
  return (
    <div className={`${inView ? 'transition-opacity' : 'opacity-0'} flex flex-col m-auto text-center py-12 duration-[2000ms]`} ref={ref}>
      <div className="container">
        <img src="./assets/Myself.jpg" alt="Headshot of Jonathan Navarrete" className="rounded-full m-auto min-w-[30em] max-h-[30em] landscape:max-lg:min-w-[10em] landscape:max-lg:max-h-[10em] shadow-circle shadow-amber-100 object-cover object-bottom"></img>
