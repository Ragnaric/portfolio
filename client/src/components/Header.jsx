  ...
  return (
    <div className={`${inView ? 'transition-opacity' : 'opacity-0'} flex-col m-auto w-1/2 text-center py-48 duration-[2000ms]`} ref={ref}>
      <div className="container py-24">
        <img src="./assets/Myself.jpg" alt="Headshot of Jonathan Navarrete" className="rounded-full m-auto min-w-[300px] max-h-[300px] shadow-circle shadow-amber-100 object-cover object-bottom lg:min-w-[550px] lg:max-h-[550px]"></img>
